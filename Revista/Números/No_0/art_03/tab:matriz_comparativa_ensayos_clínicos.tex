...
{\centering\small\setstretch{1.35}\rowcolors{3}{White}{Grey}

\begin{tabular}{M{3em}M{5em}M{5em}M{4em}M{4em}M{4em}M{4em}M{4em}M{5em}M{6em}}\hline
    
    \multirow{3}{3em}{\tmultiheader{Días}} & \multirow{3}{5em}{\tmultiheader{Población (M)\tnote{1}}} & \multirow{3}{5em}{\tmultiheader{Población (PLC)\tnote{2}}} & \multirow{4}{3em}{\tmultiheader{Dosis (mg/día)}} & \multicolumn{4}{c}{\tmultiheader{Reducción\tnote{3}}} & \multirow{3}{6em}{\tmultiheader{Adaptógeno}} & \multirow{3}{6em}{\tmultiheader{Referencia}} \\
