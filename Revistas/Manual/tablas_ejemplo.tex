...
\begin{tabular}{M{0.4\linewidth}M{0.4\linewidth}}\hline
    ...
    \sffamily\bfseries\cellcolor{DarkBlue}\textcolor{White}{Encabezado 1} & \sffamily\bfseries\cellcolor{DarkBlue}\textcolor{White}{Encabezado 2} \\ \hline
...
\begin{tabular}{M{0.4\linewidth}M{0.4\linewidth}}\hline
    ...
    \sffamily\bfseries\cellcolor{White}\textcolor{DarkBlue}{Encabezado 1} & \sffamily\bfseries\cellcolor{White}\textcolor{DarkBlue}{Encabezado 1} \\ \hline
